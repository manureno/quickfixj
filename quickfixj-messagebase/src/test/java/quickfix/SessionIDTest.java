...
public class SessionIDTest extends TestCase {
	...
	public void testAllFieldConstructor() throws Exception {
		SessionID sessionID = new SessionID("FIX.4.2", "SENDER", "SENDERSUB",
				"SENDERLOC", "TARGET", "TARGETSUB", "TARGETLOC", "QUALIFIER");
	...
	public void testStringConstructorNoLocationSubOrQualifier()
			throws Exception {
		SessionID sessionID = new SessionID("FIX.4.2", "SENDER", "TARGET");
		assertFieldsNoLocationSubOrQualifier(sessionID);
	}
	...
	public void testEquals() throws Exception {
		...
		SessionID sessionID3 = new SessionID(
				"FIX.4.2:SENDER2->TARGET2:QUALIFIER");
	...
	public void testNullInFieldConstructor() {
		SessionID sessionID = new SessionID(null, null, null, null, null, null,
				null, null);
		assertEmptyStrings(sessionID);
	}

	public void testNullInStringConstructor() {
		SessionID sessionID = new SessionID((String) null, null, null, null,
				null, null, null, null);
		assertEmptyStrings(sessionID);
	}
	...
	public void testStringConstructor() throws Exception {
		SessionID sessionID = new SessionID(
				"FIX.4.2:SENDER/SSUB/SLOC->TARGET/TSUB/TLOC:QUALIFIER");
		assertEquals("FIX.4.2", sessionID.getBeginString());
		assertEquals("SENDER", sessionID.getSenderCompID());
		...
		assertEquals("QUALIFIER", sessionID.getSessionQualifier());
		assertEquals("FIX.4.2:SENDER/SSUB/SLOC->TARGET/TSUB/TLOC:QUALIFIER",
				sessionID.toString());
	}
	...
	public void testStringConstructorNoSubLocationOrQualifier()
			throws Exception {
		SessionID sessionID = new SessionID("FIX.4.2:SENDER->TARGET");
		assertEquals("FIX.4.2", sessionID.getBeginString());
		assertEquals("SENDER", sessionID.getSenderCompID());
	...
	public void testSessionIDFileName() {
		SessionID sessionID = new SessionID(FixVersions.BEGINSTRING_FIX44,
				"SENDER???", "bla_/--/#()_bla", "!!!TARGET", "foo::bar");
		String sessionIdFileName = SessionID.sessionIdFileName(sessionID);
		assertEquals("FIX.4.4-SENDER____bla__--_____bla-___TARGET_foo__bar",
				sessionIdFileName);
		assertTrue(sessionIdFileName.matches("[a-zA-Z0-9-._]*"));

		sessionID = new SessionID(FixVersions.BEGINSTRING_FIX44, "SENDER",
				"TARGET");
